...
var ctx = window.location.pathname.substring(0, window.location.pathname.indexOf("/",2));
	...
	function loginBtnClick(){
			...
			tag +='<button id = joinbtn1 type = "button" onclick="location.href =\''+ctx+'/app/user/loginView.me\'"><i class="fas fa-male"></i><br><br>개인</button>'
			tag +='<button id = joinbtn2 type = "button" onclick="location.href =\''+ctx+'/app/user/enterpriseLoginView.me\'"><i class="far fa-building"></i><br><br>기업</button>'
			tag +='</div>';
				$('#indexBtn').html(tag);
	}